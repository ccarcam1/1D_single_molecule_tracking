...
my_directory = 'C:\Users\carca\OneDrive - Johns Hopkins University\Ha_CCarcamo\Data_Analysis\Projects\SWR1 Project\Optimizing Scripting\10-10-2019 ATP 70mM NaCl\';
cd(my_directory)
...
load('data.mat')
green_segmentation = my_segment_kymos(1, length(data), 'green');
...
disp('..................')
keep_these_structure = my_visualize_fits(1, 1, green_fitting_MSD_structure);